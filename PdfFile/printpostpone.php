...
class MergePdf{
	...
	public static function merge($files, $destination = null, $outputPath = null){
		...
		$url = "https://mua.kpru.ac.th/apipostpone/Report/ReportDetailStudent?ID_NO=".$id_no;
		$curl = curl_init($url);
		curl_setopt($curl, CURLOPT_URL, $url);
		curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
		$headers = array(
        ...
        if ($respone[0]['status_Vicerector'] == '1') {
            $htmlcontent='
				<table>
					<tr>
						<th align="center" width="50%"><b>เจ้าหน้าที่ทะเบียนและประมวลผล</b><br />ตรวจสอบเอกสาร</th>
						<th align="center" width="50%"><b>ความเห็นอาจารย์ที่ปรึกษา</b><br />'.$respone[0]['reason_Teacher'].'</th>
					</tr>
					<tr>
						<th align="center" width="50%"><img src="https://e-par.kpru.ac.th/timeKPRU/contents/signature/'.$respone[0]['citizent'].'.jpg" height="30"></th>
						<th align="center" width="50%"><img src="'.$respone[0]['setDataImages_Teacher'].'" height="30"></th>
					</tr>
					<tr>
						<th align="center" width="50%">( '.$respone[0]['prename_admin'].$respone[0]['name_admin'].'  '.$respone[0]['lname_admin'].' )</th>
			...
			';
        }else if ($respone[0]['status_registration'] == '3') {
            $htmlcontent='
			<table>
				<tr>
					<th align="center" width="50%"><b>เจ้าหน้าที่ทะเบียนและประมวลผล</b><br />ตรวจสอบเอกสาร</th>
